var TenMaxScript = document.querySelector('#calendarImgTaipeiJs');
var TenMaxLink = 'https://www.tcawg.com/travel/-pv-117.html?utm_source=Tenmax&utm_medium=cpc&utm_campaign=SAYA';
var iOSCalendar = 'https://www.tcawg.com/travel/-pv-117.html?utm_source=Tenmax&utm_medium=cpc&utm_campaign=SAYA';
var androidCalendar = 'https://www.tcawg.com/travel/-pv-117.html?utm_source=Tenmax&utm_medium=cpc&utm_campaign=SAYA';
...
let TenMaxTemplate = document.querySelector("#calendarImgTaipei");
...
async function startCountDown() {
  let diffTime = (() => {
    let endTime = (new Date(2024, 10, 1, 0, 0)).getTime(); // 月份(從 0 開始算)
