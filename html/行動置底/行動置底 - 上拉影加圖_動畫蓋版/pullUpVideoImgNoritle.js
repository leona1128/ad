var TenMaxScript = document.querySelector('#pullUpVideoImgNoritleJs');
var TenMaxLink = 'https://www.noritle.tw/SalePage/Index/9068733';
...
var TenMaxCREATIVE_ID = TenMaxScript.dataset.CREATIVE_ID;
var TenMaxCampaignId = TenMaxScript.dataset.campaignId;

let TenMaxTemplate = document.querySelector('#pullUpVideoImgNoritle');
