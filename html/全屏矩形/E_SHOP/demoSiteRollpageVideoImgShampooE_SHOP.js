var TenMaxScript = document.querySelector('#rollpageVideoImgShampooE_SHOPJs');
var TenMaxLink = 'https://bmai.app/7pzwh5';
...
let TenMaxTemplate = document.querySelector("#rollpageVideoImgShampooE_SHOP");
