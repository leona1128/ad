var TenMaxScript = document.querySelector('#pullUpimgARTTAJS');
var TenMaxLink = 'https://donation-networks.savedogs.org/';
...
let TenMaxTemplate = document.querySelector('#pullUpimgARTTA');
