...
let TenMaxTemplate = document.querySelector('#siteTelescopic');
...
let TenMaxBannerBundle2 = firstInterstitial.querySelector('.TenMaxBannerBundle2');
...
let pic1Elementtt = document.querySelector('.pic1');
...
pic1Elementtt.addEventListener('click', function(e) {
  e.preventDefault();
  e.stopPropagation();
...
function handleBarTouch(e) {
  ...
  if (!animationInProgress && shakeAdded && pic1Elementtt) {
...
let Init = function() {
  ...
  firstInterstitial.classList.add('startTmx');
  setTimeout(function() {
    firstInterstitial.classList.remove('startTmx');
