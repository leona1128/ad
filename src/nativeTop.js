...
function setupContainer(space, ad) {
  ...
  container.style.top = topCssValue = '-' + container.offsetHeight + 'px';
...
function openContainer(defaultSetting) {
  ...
  topCssValueForShutDown = - (container.offsetHeight + document.querySelector('#close-btn').offsetHeight) + 'px';
