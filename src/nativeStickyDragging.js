rmaxloaders._register(document.currentScript,function(loader){
    ...
    // 預設值
    args.enableDrag = defaultVal(args.enableDrag, false);
    args.dragWidth = defaultVal(args.dragWidth, 30);
    args.minClickableSize = defaultVal(args.minClickableSize, 80);
    args.overlayColor = defaultVal(args.overlayColor, 'rgba(0, 0, 0, 0)');
    ...
    var containerInstalled$ = asset.get$(`demo/${containerId}.html`)
      .then(function(template) {
        ...
        draggableOverlay = new DraggableOverlay(container, {
            dragWidth: args.dragWidth,
            minClickableSize: args.minClickableSize,
    ...
    class DraggableOverlay {
        constructor(container, options = {}) {
            ...
            this.options = {
                dragWidth: options.dragWidth,
                minClickableSize: options.minClickableSize,
